        ...
        <>
            <div className="living-form-box">
                <div className="event-form-box-header">
                    ...
                    <div>
                        <svg className="event-form-add-button" fill="#9c9696" height='20px' width='20px' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45.402 45.402" onClick={e => setLivingModalState('Add')}>
