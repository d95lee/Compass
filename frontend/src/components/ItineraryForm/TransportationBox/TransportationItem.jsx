    ...
    return (
        <>
            <div className='transportation-box'>
                <div className='event-box-title'>Transportation: {transportation.transportationTitle}</div>
                <div className='timeline-box-description'>Description: {transportation.description}</div>
