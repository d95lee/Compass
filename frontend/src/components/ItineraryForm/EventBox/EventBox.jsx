        ...
        <>
            <div className="event-form-box">
                <div className="event-form-box-header">
                    <div className='event-form-header-text'>EVENTS</div>
                    {/* <div> */}
                        <svg className="event-form-add-button" fill="#9c9696" height='18px' width='18px' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45.402 45.402" onClick={()=>setEventModalState('Add')}>
