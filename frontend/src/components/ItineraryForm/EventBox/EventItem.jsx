    ...
    return (
        <>
            <div className='event-box'>
                ...
                <div className='timeline-box-time'>Start Time: {event.startTime}</div>
                <div className='timeline-box-time'>End Time: {event.endTime}</div>

                <div className='timeline-box-cost'>Cost: ${event.cost}</div>
                <div className='timeline-box-category'>Category: {event.category}</div>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 105.16 122.88" style={{fillRule: "evenodd"}} className='timeline-event-delete-button' onClick={handleDeleteButton}>
                    <title>delete</title>
