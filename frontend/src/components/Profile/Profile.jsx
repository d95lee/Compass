            ...
            <div className='user-info-box'>
                ...
                <div className='user-info'>
                    ...
                    <div className='user-bio'>
                        <span className='user-bio-title'>BIO: </span>{user?.bio}
                        <svg className="user-bio-edit-button" fill="#9c9696" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 494.936 494.936" onClick={() => setBioState(true)}>
